...
#     """
#     Find and return only the largest connected component from colored areas
#     """
#     try:
...
#         # **NEW: Crop to tight bounding box of colored pixels**
#         # Find non-zero pixels in the result
...
#             # Crop to remove all black borders
#             result = result[rmin:rmax + 1, cmin:cmax + 1]
        
#         # Cleanup
#         del gray, binary_mask, labels, stats, centroids, areas, largest_mask, largest_mask_3d, non_zero, rows, cols
#         return result
