    ...
    try:
        with timer.time_process("Total Request"):
            ...
            with timer.time_process("Segmentation Processing"):
                ...
                #                         element_data['similar_segments_info'][idx]['image_base64'] = base64_data
                #                         # Also add a simpler list for convenience
                #                         similar_images_base64.append({
                ...
                #             except Exception as e:
                #                 logger.error(f"Error encoding reference image {info['path']}: {str(e)}")
                #
                #         # Add the list to the element data
                #         element_data['similar_images_base64'] = similar_images_base64
